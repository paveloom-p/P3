...
open(3, file = 'output')     ! и файла вывода
...
logical function ReadHipparcosMain(s,Want_Sp) ! Чтение данных о звезде
type(THipparcos), intent(out) :: s
character(450) hs ! Запись строки каталога

character(10) Want_Sp ! Желаемый спектральный класс
...
write(3,*) get_out(s,Want_Sp)

end function ReadHipparcosMain

! Пользовательская функция

integer(4) function get_out(s,Want_Sp)
type(THipparcos), intent(out) :: s
character(10) Want_Sp

if (s%Sp .eq. Want_Sp) get_out=s%HIP
